...
const translations = {
    es: {
        ...
        'about.skills': 'Me especializo en R eact, Next.js, TypeScript y Node.js con Express, y trabajo tanto en el frontend como en el backend. Tengo capacidad para crear APIs robustas y gestionar bases de datos (SQL y MongoDB), conectando el frontend con lógica de servidor eficiente.',
        'about.tools': 'Utilizo Tailwind CS S y otras herramientas modernas para crear interfaces responsivas y escalables. Cada proyecto es una oportunidad para aprender algo nuevo y superar desafíos técnicos.',
        'about.hobby': 'Cuando no estoy pr ogramando, me gusta estar al día con las últimas tendencias tecnológicas, contribuir a proyectos open source y compartir conocimiento con la comunidad.',
